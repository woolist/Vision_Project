...
def predict():
    if request.method == "POST":
        DeleteAllFiles('C:/Users/admin/project3/project3/static/aft')  # 파일 업로드 후 새로 검사 시작할 때마다 폴더 내 파일 삭제
        DeleteAllFiles('C:/Users/admin/project3/project3/static/bef')  # 경로설정필요
        ...
        return render_template("result.html",files=files,pf=pf,firstimage=firstimage,enumerate=enumerate,len=len)    
